...
**Estado verificado em 14/09/2026:** primeiro piloto gerado, revisado no Telegram e enviado ao YouTube como privado. O objetivo editorial é produto-primeiro: demonstrar utilidade, limitações e público adequado antes do CTA. Links de afiliado são preservados pelo sistema e entram nas descrições com disclosure; TikTok Shop continua com anexação manual do produto. Supabase, Tavily, Gemini, Pexels e fallback de voz no Actions integram o fluxo; o pipeline permanece pausado. [QA editorial](docs/ADR/ADR-016-qualidade-editorial-antes-dos-assets.md), [evidências de pesquisa](docs/ADR/ADR-023-pesquisa-gratuita-tavily.md), [afiliação determinística](docs/ADR/ADR-026-produto-primeiro-e-afiliado-deterministico.md) e [auditoria atual](docs/auditoria-2026-09-14.md) registram o estado. Analytics, monitoramento/retencão e publicação pública/Shorts ainda faltam.
