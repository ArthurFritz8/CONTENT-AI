...
- SocialCrawl documenta busca de produtos com `region=BR`, mas não confirma comissão, vínculo afiliado ou autorização do TikTok. Trends MCP fornece quadros gerais de produtos quentes, sem confirmar disponibilidade regional, estoque ou elegibilidade. Em 22/09/2026, a API autenticada rejeitou `TikTok Shop Hot Products` como tipo desconhecido apesar de a página pública anunciá-lo; o feed suportado `Amazon Best Sellers Top Rated` foi adotado como sinal geral, com fallback automático.
